...
<div class="page-wrapper">
    ...
    <main class="content">
        <h1>{report_name}</h1>
        <p style="font-size: 12px; color: var(--fg-muted); margin-bottom: 4px;">Generated by <a href="https://github.com/djrien-ai/pbi-doc-generator" style="color: var(--fg-muted);"><strong>PBI Doc Generator</strong></a> v0.1 beta &mdash; by Rien Scheerlinck</p>
        <p class="subtitle">Data layer reference for redevelopment. Report pages / visuals are out of scope.</p>
        {sections_html}
    </main>
