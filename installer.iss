...
OutputBaseFilename=PBI_Doc_Generator_Setup_v0.3-beta
...
[Files]
Source: "dist\PBI_Doc_Generator_v0.3-beta.exe"; DestDir: "{app}"; DestName: "PBI_Doc_Generator.exe"; Flags: ignoreversion
